...
async def test_segment_and_score_parses_llm_json():
    cues = [
        TranscriptCue(start=i, end=i + 2, text=f"line {i}") for i in range(0, 60, 2)
    ]
    fake_response = json.dumps(
        [
            ...
            },
            {
                ...
                "transcript_excerpt": "line 30...",
            },
        ]
    )
    with patch(
        "services.clips.segment._ask_llm_for_segments",
