                    ...
                    with patch(
                        ...
                        with patch(
                            ...
                            with patch(
                                ...
                                mock_supabase.storage.from_.return_value.list = (
                                    AsyncMock(return_value=[{"name": "photo1.jpg"}])
                                )

                                graph = build_thumbnail_graph(
                                    use_memory_checkpointer=True
                                )
                                config = {
                                    "configurable": {"thread_id": "integration-2"}
                                }
                ...
                with patch(
                    ...
                    with patch(
                        ...
                        result2 = await graph.ainvoke(
                            Command(
                                resume={"action": "feedback", "feedback": "too dark"}
                            ),
                            config,
                        )
                    ...
                    with patch(
                        ...
                        with patch(
                            ...
                            with patch(
                                ...
                                mock_supabase.storage.from_.return_value.list = (
                                    AsyncMock(return_value=[{"name": "p.jpg"}])
                                )
                                ...
                                config = {
                                    "configurable": {"thread_id": "integration-4"}
                                }
